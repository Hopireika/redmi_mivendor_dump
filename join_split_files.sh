...
cat vendor_bootimg/06_dtbdump_Qualcomm_Technologies,_Inc._Khajeq_SoC.dtb.* 2>/dev/null >> vendor_bootimg/06_dtbdump_Qualcomm_Technologies,_Inc._Khajeq_SoC.dtb
rm -f vendor_bootimg/06_dtbdump_Qualcomm_Technologies,_Inc._Khajeq_SoC.dtb.* 2>/dev/null
cat vendor_dlkm/lib/modules/qca_cld3_wlan.ko.* 2>/dev/null >> vendor_dlkm/lib/modules/qca_cld3_wlan.ko
rm -f vendor_dlkm/lib/modules/qca_cld3_wlan.ko.* 2>/dev/null
...
cat product/app/Biometric/Biometric.apk.* 2>/dev/null >> product/app/Biometric/Biometric.apk
rm -f product/app/Biometric/Biometric.apk.* 2>/dev/null
...
cat mi_ext/product/data-app/Opera/Opera.apk.* 2>/dev/null >> mi_ext/product/data-app/Opera/Opera.apk
rm -f mi_ext/product/data-app/Opera/Opera.apk.* 2>/dev/null
cat mi_ext/product/data-app/MISTORE_OVERSEA/MISTORE_OVERSEA.apk.* 2>/dev/null >> mi_ext/product/data-app/MISTORE_OVERSEA/MISTORE_OVERSEA.apk
rm -f mi_ext/product/data-app/MISTORE_OVERSEA/MISTORE_OVERSEA.apk.* 2>/dev/null
